...
def test_epistemic_integrity():
    ...
    outputs_low = {"p10": 1.0, "p90": 10.0, "porosity": 0.15, "sw": 0.3}
    pos_coupled = {"Charge": "model_v1", "Reservoir": "model_v1", "Trap": "model_v1", "Seal": "model_v1"}
    ...
    pos_diverse = {"Charge": "basin_model_v4", "Reservoir": "petrophys_v2", "Trap": "seismic_v9", "Seal": "seal_model_v1"}
