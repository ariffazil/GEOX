...
async def geox_evidence_discover(
    ...
    return {
        ...
        "dim_spot_flag": False,
        "result": {"query": query, "scope": scope, "candidates": candidates},
        "error": None,
...
async def geox_report_to_workflow(
    ...
    if "tie" in intent_lower or "seismic" in intent_lower:
        steps = [
            ...
            {
                "step": 2,
                "action": "identify seismic volume / line",
                "details": "Match seismic survey area with report coordinates.",
            },
            {
                "step": 3,
                "action": "identify checkshot/VSP",
                "details": "Validate time-depth survey parameters from report checkshots.",
            },
            {
                "step": 4,
                "action": "inspect sonic and density logs",
                "details": "Call geox_header_inspect to check log parameters.",
            },
            ...
            {"step": 7, "action": "select wavelet", "details": "Extract or model wavelet from seismic boundaries."},
            {
                ...
                "details": "Convolve reflection coefficients with wavelet using geox_seismic_compute.",
            },
            ...
            {
                "step": 11,
                "action": "flag missing evidence",
                "details": "Raise dim-spot alerts if DT/RHOB or checkshots are absent.",
            },
        ...
        steps = [
            ...
            {
                "step": 4,
                "action": "verify seal integrity",
                "details": "Check fault seal displacement and column height calculations.",
            },
            {"step": 5, "action": "run charge modeling", "details": "Incorporate thermal history and burial curve from report."},
            {
                "step": 6,
                "action": "evaluate POS",
                "details": "Calculate Probability of Geological Success using geox_prospect_evaluate.",
            },
