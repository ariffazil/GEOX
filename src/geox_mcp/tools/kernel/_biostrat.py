...
NN_AGES: dict[str, tuple[float, float]] = {
    "NN21": (0.00, 0.46), "NN20": (0.46, 1.04), "NN19": (1.04, 1.73),
    "NN18": (1.73, 2.31), "NN17": (2.31, 3.54), "NN16": (3.54, 4.13),
    "NN15": (4.13, 4.37), "NN14": (4.37, 5.04), "NN13": (5.04, 5.59),
    "NN12": (5.59, 6.91), "NN11C": (6.91, 7.42), "NN11B": (7.42, 7.67),
    "NN11A": (7.67, 8.59), "NN11": (6.91, 8.59),
    "NN10B": (8.59, 9.53), "NN10A": (9.53, 10.41), "NN10": (8.59, 10.41),
    "NN9C": (10.41, 10.80), "NN9B": (10.80, 11.21), "NN9A": (11.21, 11.79),
    "NN9": (10.41, 11.79), "NN8": (11.79, 12.12),
    "NN7": (12.12, 13.12), "NN6": (13.12, 13.65), "NN5": (13.65, 14.91),
    "NN4": (14.91, 17.95), "NN3": (17.95, 19.01), "NN2": (19.01, 20.44),
    "NN1": (20.44, 23.03),
}
...
GDE_RULES: list[tuple[str, str, str, int, str]] = [
    ...
    (r"intertidal|tidal|estuar|lagoon|mangrove", "2026_TIDAL", "Tidal flat / estuarine",          3, "Tidal-flat, estuarine, or restricted marginal marine"),
...
def map_gde(paleoenvironment: str, lithology: str = "") -> dict[str, Any]:
    ...
    if not text.strip():
        return {
            "code": "UNKNOWN", "label": "UNKNOWN", "index": -1,
    ...
    if re.search(r"sand|sandstone|silt|clay|mud|shale", text, flags=re.I):
        return {
            "code": "2026_CLASTIC_UNDIFF", "label": "Clastic undifferentiated", "index": 4,
