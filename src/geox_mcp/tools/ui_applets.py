...
def register_ui_applets(mcp: FastMCP) -> None:
    ...
    async def geox_applet_crossplot(well_id: str) -> dict[str, Any]:
        ...
        return {
            "content": [{"type": "text", "text": f"Cross-plot for well {well_id} generated. See the interactive panel."}],
            "_meta": {"ui": {"resourceUri": f"ui://geox/crossplot?well_id={well_id}", "presentation": "panel"}},
        }
