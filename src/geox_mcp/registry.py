...
GEOX_TOOL_MANIFEST: list[dict[str, Any]] = [
    ...
    # ── SEISMIC VISION AI (4) — Phase 3.2 (2026-07-06) ─────────────────────
    {
        "name": "geox_visual_understand",
        "domain": "earth.seismic",
        "axis": "observe",
        "lane": "evidence",
        "expose": True,
    ...
    {
        "name": "geox_visual_generate_hypotheses",
        "domain": "earth.seismic",
        "axis": "reason",
        "lane": "reasoning",
        "expose": True,
    ...
    # ── PHYSICAL REALITY + COGNITIVE (3) — Phase 3.2 ───────────────────────
    {
        "name": "geox_cognitive_rank_hypotheses",
        "domain": "earth.seismic",
        "axis": "reason",
        "lane": "reasoning",
        "expose": True,
    ...
    # ── ATLAS + CONTRAST (2) — already in SURFACE_TOOLS ────────────────────
    {
        "name": "geox_map_layers_list",
        "domain": "earth.map",
        "axis": "observe",
        "lane": "discovery",
        "expose": True,
    ...
    # ── PHYSICS-FIRST STRATIGRAPHY (4) — Phase 3.0 ────────────────────────
    {
        "name": "geox_simulate_accommodation",
        "domain": "earth.stratigraphy",
        "axis": "reason",
        "lane": "reasoning",
        "expose": True,
    ...
    # ── BIOSTRAT (4) — Phase 2.7 ──────────────────────────────────────────
    {
        "name": "geox_biostrat_parse",
        "domain": "earth.stratigraphy",
        "axis": "observe",
        "lane": "evidence",
        "expose": True,
    ...
    {
        "name": "geox_biostrat_ruling_check",
        "domain": "earth.stratigraphy",
        "axis": "verify",
        "lane": "evidence",
        "expose": True,
    ...
    {
        "name": "geox_macrostrat_calibrate",
        "domain": "earth.stratigraphy",
        "axis": "reason",
        "lane": "evidence",
        "expose": True,
    ...
    # ── TIE METABOLIZER (2) — Phase 3.3 (2026-07-06) ──────────────────────
    {
        "name": "geox_tie_receipt",
        "domain": "earth.seismic",
        "axis": "verify",
        "lane": "evidence",
        "expose": True,
