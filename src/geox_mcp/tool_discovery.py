...
TOOL_DISCOVERY: dict[str, ToolDiscovery] = {
    ...
    "geox_seismic_compute": ToolDiscovery(
        ...
        description="Seismic computation: synthetics, well ties, AVO analysis, attributes, seismic inversion. Time-depth anchoring is checkshot-only (Law 5: Convergence Over Choice).",
