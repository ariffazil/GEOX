...
def register_tools_on(mcp):
    ...
    try:
        ...
        async def _contrast_metabolize(
            ...
            actor_id: str | None = None,
            trace_id: str | None = None,
            session_token: str | None = None,  # gateway-injected (ACT) — absorbed, not required
            sct: str | None = None,  # legacy alias — absorbed
            act: str | None = None,  # preferred alias — absorbed
        ) -> dict[str, Any]:
