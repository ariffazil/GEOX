...
def register_tools_on(mcp):
    ...
    # ═══════════════════════════════════════════════════════════════════
    # H3: GEOX Contrast Metabolize — unified anomalous contrast pipeline
    # Eureka ratified 2026-08-13. Manifest declares it as the 19th public tool,
    # implementation existed but was never wired into the MCP surface → gap of 1.
    # ═══════════════════════════════════════════════════════════════════
    ...
    async def _contrast_metabolize(
        ...
        Local max: QUALIFIED_CANDIDATE (arifOS seals — never self-seals).
        """
