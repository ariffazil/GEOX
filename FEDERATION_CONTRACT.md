...
**OWNS:** Well logs, seismic, petrophysics, basin screening, prospect evaluation, stratigraphic interpretation.
**NEVER:** Issue drilling decisions, authorize capital allocation, adjudicate constitutional verdicts.

## Contract Compliance

- [x] Points to kernel SoT from README
- [x] Has GENESIS/ (000-003)
