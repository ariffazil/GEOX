...
**OWNS:** Well logs, seismic, petrophysics, basin screening, prospect evaluation, stratigraphic interpretation, claim generation.
**NEVER:** Issue drilling decisions, authorize capital allocation, adjudicate constitutional verdicts, final-answer sovereign decisions.

## Four Transport Lanes

| Lane | Max Authority | Lease Required | Session Required | Tools |
|------|--------------|----------------|-----------------|-------|
| **Discovery** | OBSERVE | No | No | `geox_system_registry_status`, `geox_attribute_registry_list_tool`, `geox_basin_resolve`, `geox_query_intake`, `geox_query_macrostrat` |
...
| **Judgment** | GOVERNED | Yes | Yes | `geox_claim_create`, `geox_claim_validate`, `geox_claim_challenge`, `geox_claim_seal`, `geox_segy_export_tool` |
