...
class GEOXMCPTestSuite:
    ...
    async def test_mcp_list_tools(self) -> bool:
        ...
        try:
            async with httpx.AsyncClient(
                ...
                response = await client.post(
                    self.mcp_url, json={"jsonrpc": "2.0", "id": 2, "method": "tools/list", "params": {}}, timeout=10.0
                )
            ...
            async with httpx.AsyncClient(
                ...
                response = await client.post(
                    ...
                    json={
                        ...
                        "id": 3,
                        "method": "tools/call",
                        "params": {"name": "geox_surface_status", "arguments": {"mode": "registry"}},
                    },
                    timeout=30.0,
                )
    ...
    async def test_mcp_call_health_tool(self) -> bool:
        """Test MCP call tool (geox_seismic_interpret)."""
        test_name = "MCP Call Tool (geox_seismic_interpret)"
            ...
            async with httpx.AsyncClient(
                ...
                response = await client.post(
                    ...
                    json={
                        ...
                        "id": 4,
                        "method": "tools/call",
                        "params": {"name": "geox_seismic_interpret", "arguments": {"mode": "horizon_contrast"}},
                    },
                    timeout=10.0,
                )
    ...
    async def test_mcp_list_resources(self) -> bool:
        ...
        try:
            async with httpx.AsyncClient(
                ...
                response = await client.post(
                    self.mcp_url, json={"jsonrpc": "2.0", "id": 6, "method": "resources/list", "params": {}}, timeout=10.0
                )
    ...
    async def test_mcp_read_resource(self) -> bool:
        ...
        try:
            async with httpx.AsyncClient(
                ...
                response = await client.post(
                    self.mcp_url,
                    json={"jsonrpc": "2.0", "id": 7, "method": "resources/read", "params": {"uri": "geox://capabilities"}},
                    timeout=10.0,
                )
    ...
    async def test_mcp_list_prompts(self) -> bool:
        ...
        try:
            async with httpx.AsyncClient(
                ...
                response = await client.post(
                    self.mcp_url, json={"jsonrpc": "2.0", "id": 8, "method": "prompts/list", "params": {}}, timeout=10.0
                )
    ...
    async def test_mcp_get_prompt(self) -> bool:
        ...
        test_name = "MCP Get Prompt (geox_qc)"
        ...
        try:
            async with httpx.AsyncClient(
                ...
                response = await client.post(
                    self.mcp_url,
                    json={"jsonrpc": "2.0", "id": 9, "method": "prompts/get", "params": {"name": "geox_qc", "arguments": {}}},
                    timeout=10.0,
                )
...
Examples:
    ...
    parser.add_argument(
        "--url", default="http://localhost:8000", help="Base URL of GEOX MCP server (default: http://localhost:8000)"
    )
