...
**MCP Server URL:** `https://geox.arif-fazil.com/mcp`
...
```json
{
  "mcpServers": {
    "geoxarifOS": {
      ...
      "env": {
        "MCP_PROXY_URL": "https://geox.arif-fazil.com/mcp"
      }
    }
  }
}
...
**Step 1:** Add Server
```bash
gemini mcp add geoxarifOS https://geox.arif-fazil.com/mcp --transport http
```
...
agent = await ArifOSAgent.create_geox_agent(
    mcp_url="https://geox.arif-fazil.com/mcp",
...
**Version:** 0.5.0  
**Server:** https://geox.arif-fazil.com/mcp