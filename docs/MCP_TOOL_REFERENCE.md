...
- **Server invariant:** [`src/geox_mcp/server.py`](../../src/geox_mcp/server.py) `_EXPECTED_CANONICAL = 34`
...
**DITEMPA BUKAN DIBERI — 34 canonical tools, constitutionally wrapped, ready for the kernel to judge.**
