...
| Tool count | 20 canonical (`CANONICAL_PUBLIC_TOOLS` in `src/geox_mcp/server.py`) | ✅ |
...
- ❌ Tool count `28` — the live surface is **20 canonical** (`CANONICAL_PUBLIC_TOOLS`)
- ❌ Tool count `21` — same: 20 is the truth
...
## Related Files
- `src/geox_mcp/server.py` — canonical daemon (20 canonical tools)
